...
const handleUseCurrentLocation = useCallback(async () => {
  ...
  const applyPriceAndRatingFilters = useCallback(async (filterState: any) => {
    ...
    try {
      ...
      // Check if we have price ranges selected

      const hasPriceFilter = filterState.selectedPriceRanges && filterState.selectedPriceRanges.length > 0;

      const hasRatingFilter = filterState.rating !== undefined;
      ...
      if (hasPriceFilter && hasRatingFilter) {
        ...
        const selectedRange = filterState.selectedPriceRanges[0];
        ...
        response = await filterProductsByPriceRange(minPrice, maxPrice, 0, 20);
  ...
  response = await filterProductsByRating(
    ...
    20
      ...
      // Map the response to match your existing product structure
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        const { data } = await api.get(sizesPath);
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        const { data } = await api.get(colorsPath);
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        const { data } = await api.get(pricesPath);
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        const { data } = await api.get(ratingPath);
            ...
            <View style={styles.filterContent}>
              ...
              <View style={styles.filterRightPanel}>
                ...
                <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
                    ...
                    sizesLoading ? (
                      ...
                      sizes.map((size) => (
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => toggleFilterOption("Size", size.name)}
                        ...
                        >
                          ...
                          <Text style={styles.categoryParentText}>{size.name}</Text>
                    ...
                    colorsLoading ? (
                      ...
                      colors.map((color) => (
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => toggleFilterOption("Color", color.name)}
                        ...
                        >
                          ...
                          <Text style={styles.categoryParentText}>{color.name}</Text>
                  ...
                  {selectedFilterSection === "Gender" && (

                    filterOptions.Identity.map((gender) => (
      ...
      params: {
        genderType: "kids",
                      ...
                      >
                        ...
                        <Text style={styles.categoryParentText}>{gender}</Text>
                    ...
                    <>
                      ...
                      {[
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => toggleFilterOption("Price", priceRange.id)}
                        ...
                        >
                          ...
                          <View
                            ...
                            style={[
                              ...
                              selectedFilters["Price"]?.includes(priceRange.id) &&
                          ...
                          <Text style={styles.categoryParentText}>{priceRange.label}</Text>
                    ...
                    ratingsLoading ? (
                      ...
                      ratings.map((rating) => (
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => toggleFilterOption("Rating", rating.name)}
                        ...
                        >
                          ...
                          <View
                            ...
                            style={[
                              ...
                              selectedFilters["Rating"]?.includes(rating.name) &&
                          ...
                          <Text style={styles.categoryParentText}>{rating.name}</Text>

...
const MEN_IMAGE = require("../assets/MainCatImages/images/Men.png");
    ...
    <View style={styles.root}>
          ...
          >
            <View style={styles.menLogoTile}>
              <Image
                ...
                resizeMode="contain"
              />
              <View style={styles.menLogoBrandDot} />
            </View>
          </TouchableOpacity>
      ...
      >
        <View style={styles.heroWrap}>
          ...
          <Image source={MEN_IMAGE} style={styles.heroImage} resizeMode="cover" />
          <LinearGradient
          ...
          <View style={styles.heroTextBox}>
            <Text style={styles.heroKicker}>Men&apos;s fashion</Text>
            <Text style={styles.heroHead}>Shop the men&apos;s edit</Text>
        ...
        <View style={styles.fcWrap}>
          ...
          <MenStoreSection>
            ...
            <Image source={MEN_IMAGE} style={styles.fcSpotlightImg} resizeMode="cover" />
            <LinearGradient
            ...
            <View style={styles.fcSpotlightCopy}>
              ...
              <Text style={styles.fcSpotlightHead}>The men&apos;s studio drop</Text>
              <Text style={styles.fcSpotlightSub}>Tailoring meets everyday ease — tap categories above to shop.</Text>

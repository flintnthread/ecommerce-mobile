...
const WOMEN_CATEGORIES: WomenCategoryBlock[] = [
  {
    ...
    railTo: "#c2410c",
    subs: [
      { id: "w1", label: "Sarees", image: WOMEN_IMG },
      { id: "w2", label: "Kurtas & Kurtis", image: WOMEN_IMG },
      { id: "w3", label: "Lehengas", image: WOMEN_IMG },
      { id: "w13", label: "Gowns", image: WOMEN_IMG },
    ],
  },
  {
    key: "western",
    ...
    railTo: "#0369a1",
    subs: [
      { id: "w7", label: "Tops & Tees", image: WOMEN_IMG },
      { id: "w8", label: "Dresses", image: WOMEN_IMG },
      { id: "w9", label: "Jeans", image: WOMEN_IMG },
    ],
  },
  {
    key: "lingerie",
    ...
    railTo: "#7c3a76",
    subs: [
      { id: "w4", label: "Bras", image: WOMEN_IMG },
      { id: "w5", label: "Briefs", image: WOMEN_IMG },
      { id: "w6", label: "Nightwear", image: WOMEN_IMG },
    ],
  },
  {
    key: "winter",
    ...
    railTo: "#334155",
    subs: [
      { id: "w10", label: "Sweaters", image: WOMEN_IMG },
      { id: "w11", label: "Jackets", image: WOMEN_IMG },
      { id: "w12", label: "Co-ords", image: WOMEN_IMG },
    ],
  },
  {
    key: "active",
    ...
    shopImage: require("../assets/images/sportscate.png"),
    railFrom: "#047857",
    railTo: "#059669",
    subs: [
      { id: "wa1", label: "Gym Tops", image: require("../assets/images/sportscate.png") },
      { id: "wa2", label: "Tights", image: require("../assets/images/sportscate.png") },
      { id: "wa3", label: "Track Pants", image: require("../assets/images/sportscate.png") },
      { id: "wa4", label: "Sports Jackets", image: require("../assets/images/sportscate.png") },
    ],
  },
];
    ...
    <View style={styles.root}>
          ...
          >
            <View style={styles.womenLogoTile}>
              <Image
                ...
                resizeMode="contain"
              />
              <View style={styles.womenLogoBrandDot} />
            </View>
          </TouchableOpacity>
      ...
      >
        <View style={styles.heroWrap}>
          ...
          <Image source={WOMEN_IMG} style={styles.heroImage} resizeMode="cover" />
          <LinearGradient
          ...
          <View style={styles.heroTextBox}>
            <Text style={styles.heroKicker}>Women&apos;s fashion</Text>
            <Text style={styles.heroHead}>Shop the women&apos;s edit</Text>
        ...
        <View style={styles.fcWrap}>
          ...
          {/* 6 — Shop all women sub categories */}
          <WomenStoreSection>
            <WomenSectionHead
              accent="#64748b"
